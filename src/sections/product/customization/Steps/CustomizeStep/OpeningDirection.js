...
const OpeningDirection = ({ data }) => {
    ...
    let step_name = data.SS_CODE_NAME ? data.SS_CODE_NAME : 'OPENING_DIRECTION';
    let stepArray = [];
    ...
    const optionFun = (val) => {
        ...
        console.log(step_name, 'openingType11', val)
        openingType(val.SPS_CODE);
        dispatch(
