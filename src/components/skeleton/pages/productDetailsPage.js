              ...
              <Grid container spacing={2}>
                <Grid item lg={6}>
                  <Skeleton
                    variant="rectangular"
                    sx={{
                      height: 40, borderRadius: 1, "&.MuiSkeleton-root": {
              ...
              <Grid container spacing={2}>
                <Grid item lg={6}>
                  <Skeleton
                    variant="rectangular"
                    sx={{
                      height: 470, borderRadius: 1, "&.MuiSkeleton-root": {
                        backgroundColor: (theme) => alpha(theme.palette.grey[400], 0.4),
                        "::after": {
                          background: (theme) => `linear-gradient(90deg, transparent, ${alpha(theme.palette.grey[900], 0.08)}, transparent)`
                        }
                  ...
                  <Grid container spacing={2}>
                    <Grid item lg={4}>
                      <Skeleton
                        variant="rectangular"
                        sx={{
                          height: 30, borderRadius: 1, "&.MuiSkeleton-root": {
                            backgroundColor: (theme) => alpha(theme.palette.grey[400], 0.4),
                            "::after": {
                              background: (theme) => `linear-gradient(90deg, transparent, ${alpha(theme.palette.grey[900], 0.08)}, transparent)`
                            }
                    ...
                    <Grid item lg={6}>
                      <Skeleton
                        variant="rectangular"
                        sx={{
                          height: 50, borderRadius: 1, "&.MuiSkeleton-root": {
                            backgroundColor: (theme) => alpha(theme.palette.grey[400], 0.4),
                            "::after": {
                              background: (theme) => `linear-gradient(90deg, transparent, ${alpha(theme.palette.grey[900], 0.08)}, transparent)`
                            }
